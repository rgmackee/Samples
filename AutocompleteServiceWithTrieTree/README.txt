**********************************************************************************************************
This project shows the implementation of a Trie data structure. This is most popularly used for suffix and prefix searches, such as auto-completion, which is what this project is about.
...
letter typed on. Only letters and at most one hyphen are accepted as valid input (Example: Ann-Marie), but no spaces are allowed (Example: Jean Paul).
